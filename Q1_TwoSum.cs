...
public class Q1_TwoSum
{
    public static void Test()
    {
        ...
        Console.WriteLine(ArrayUtil.DebugArray(result)); // 0 1 

        int[] result2 = TwoSum1(new int[] { 3, 2, 4 }, 6);
        Console.WriteLine(ArrayUtil.DebugArray(result2)); // 1 2 

        int[] result3 = TwoSum1(new int[] { 3, 3 }, 6);
        Console.WriteLine(ArrayUtil.DebugArray(result3)); // 0 1

        int[] result4 = TwoSum1(new int[] { 2, 4, 11, 3 }, 6);
        Console.WriteLine(ArrayUtil.DebugArray(result4)); // 0 1

        int[] result5 = TwoSum1(new int[] { 1, 1, 1, 1, 1, 4, 1, 1, 1, 1, 1, 7, 1, 1, 1, 1, 1 }, 11);
        Console.WriteLine(ArrayUtil.DebugArray(result5)); // 5 11
    }
