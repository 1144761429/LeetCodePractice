namespace Leetcode.Q2BestTimeToBuyAndSellStock;
...
public class Program
{
    public static void Test()
    {
        int[] arr1 = new int[] { 1 };
        Console.WriteLine(
            $"Testing {Util.DebugArray(arr1)}. Expect: 0. Actual: {MaxProfit(arr1)}.");
        
        int[] arr2 = new int[] { 7, 1, 5, 3, 6, 4 };
        Console.WriteLine(
            $"Testing {Util.DebugArray(arr2)}. Expect: 5. Actual: {MaxProfit(arr2)}.");


        int[] arr3 = new int[] { 7, 2, 5, 1, 3 };
        Console.WriteLine(
            $"Testing {Util.DebugArray(arr3)}. Expect: 3. Actual: {MaxProfit(arr3)}.");

        int[] arr4 = new int[] { 5, 5, 5, 8, 6, 10 };
        Console.WriteLine(
            $"Testing {Util.DebugArray(arr4)}. Expect: 5. Actual: {MaxProfit(arr4)}.");
        
        int[] arr5 = new int[] { 3,5,1,7,8 };
        Console.WriteLine(
            $"Testing {Util.DebugArray(arr5)}. Expect: 7. Actual: {MaxProfit(arr5)}.");
    }
